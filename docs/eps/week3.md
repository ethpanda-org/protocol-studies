...
- [以太坊.org 关于权益证明的文档](https://ethereum.org/developers/docs/consensus-mechanisms/pos) 及其子主题
- [信标链解释](https://ethos.dev/beacon-chain)
- [PoS 和太阳能朋克未来，Danny Ryan 2022](https://www.youtube.com/watch?v=8N10a1EBhBc)，合并前的演讲，对合并和信标链开发和测试的深刻见解
...
- 分布式网络处理拜占庭容错(BFT)
- 比特币首先用PoW解决了BFT
- 以太坊转向权益证明，从 Sybil 保护的外源信号切换为系统中的内源信号
- 使用 BFT 多数来确定链的状态
...
- [Justin Drake 的信标链设计错误](https://www.youtube.com/watch?v=10Ym34y3Eoo)
