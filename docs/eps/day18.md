...
本周的第一场现场会议专门讨论 Execution Layer 网络堆栈，深入探讨 devp2p。 [Felix Lange](https://github.com/fjl) 是 go-ethereum 团队的长期核心开发人员，也是 devp2p 规范的维护者。 
...
在开始第 18 天的内容之前，请先熟悉前几周的资源，尤其是 EL 上的第 3 天和 EL 客户端上的第 7 天。您应该对 Execution Layer 及其网络功能有基本的了解。 
...
- [devp2p Wireshark 解析器演示](https://www.youtube.com/watch?v=AhE4KbV-f1w)
- [Felix Lange (Devcon4) 的 devp2p 开发更新](https://www.youtube.com/watch?v=N2VTqUZRxjY)
- [Hive devp2p 测试模拟器](https://github.com/ethereum/hive/tree/master/simulators/devp2p)
