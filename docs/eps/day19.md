...
本周的第二场现场会议重点关注基于 libp2p 的 Consensus Layer 网络。本次讲座由 [DappLion](https://github.com/dapplion) 主讲，他是一位经验丰富的 Consensus Layer 贡献者，SigP Lighthouse 团队成员，曾是 Lodestar 客户端的负责人，目前主要关注 PeerDAS。
...
在开始第 19 天的内容之前，先熟悉一下前几周的资源，尤其是第 2 天的 CL 和第 16 天的共识机制。您应该对 Beacon Chain、其网络特性以及 Ethereum Consensus Layer 中的不同机制有一个大致的了解。
...
- [Ethereum 中的 libp2p 从区块扩散到 PeerDAS 和 FullDAS - <name>Csaba Kiraly</name>](https://www.youtube.com/watch?v=sI_Qr1vHUk4)
