...
本周的第二场会议是由来自 Ipsilon 团队的 [<name>Paweł</name> Bylica](https://github.com/chfast) 的讲座深入探讨 Ethereum Virtual Machine (EVM)。
...
在开始第 17 天的内容之前，请先熟悉前几周的资源，尤其是 EL 上的第 3 天和 EL 客户端上的第 12 天。您应该大致了解什么是 EVM 以及 Execution Layer 的不同部分。
对虚拟机、汇编器或解释器有一定的了解可能会很方便，但这不是必需的。

此外，您可以通过浏览以下与 Ethereum 执行相关的概念来做好准备：
...
- [互动 EVM 操作码](https://www.evm.codes)
...
- [EVM 跳跃的历史与未来](https://www.youtube.com/watch?v=8Cp8IsmIJl4)
