...
在本周的第一场会议中，我们将与 [Ben Edgington](https://x.com/benjaminion_xyz) 深入探讨 Ethereum 的共识机制。 Ben 是一位经验丰富的核心贡献者，曾参与 Teku 共识客户端、Optimism 的工作，并且是带注释的规范 Eth2 Book 的作者。 
...
在开始第 16 天的内容之前，请先熟悉前几周的资源，尤其是第 2 天的 CL 和第 6 天的规范 (至少是 CL 部分)。您应该对 Beacon Chain 和 Ethereum Consensus Layer 中的不同机制有大致的了解。 

此外，您可以通过学习以下资源来做好准备。

- Vitalik 的 [Beacon Chain 分叉选择](https://github.com/ethereum/annotated-spec/blob/master/phase0/fork-choice.md) - 过时了，但仍然很优秀
- 《升级 Ethereum》书中的 [共识章节](https://eth2book.info/latest/part2/consensus/)
