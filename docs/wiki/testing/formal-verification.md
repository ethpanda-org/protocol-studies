...
安全和活力保障是以太坊去中心化基础设施的核心。形式验证在验证以下内容的正确性方面发挥着关键作用：
...
[KEVM](https://github.com/runtimeverification/evm-semantics) 基于 [K 框架](https://kframework.org/) 构建，用于构建形式语义并对 [以太坊虚拟机 (EVM)](/wiki/EL/evm.md) 规范的正确性进行验证。
...
Solidity编译器还实现了[基于SMT(可满足性模理论)和Horn求解的形式验证方法](https://docs.soliditylang.org/en/latest/smtchecker.html)。
...
- Grant P.，[走向 Imandra 合约：以太坊的形式验证](https://www.youtube.com/watch?v=xeg_Q5uN73Q)
...
- Yan M.，[以太坊通过形式验证的视角发现错误](https://www.youtube.com/watch?v=Ru6X043Q63U)
